...
- The seam landed on main first so later spec text can describe it; it is not a standalone release. `AGENTCHUTE.md` is normative, so no released spec may describe a capability no released binary carries.
