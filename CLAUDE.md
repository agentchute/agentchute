...
If a session starts and you do not see an agentchute boot/enrolled context line, run `agentchute boot --as claude-code --vendor anthropic` before doing any work.
