...
// startup via cli.Assets.
var embeddedSpecContent string

const (
	enrollmentVersion       = 26
	gitignoreVersion        = 3
...
// drift). The embed lives in the root main package; Main injects it here.
...
// source of truth: templates/enrollment/agents.md at repo root. The embed
// lives in the root main package; Main injects it here.
