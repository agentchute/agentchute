...
func TestSetupRefreshesExistingEnrollmentBlocks(t *testing.T) {
	...
	if !strings.Contains(text, "agentchute-enrollment v31 begin") || !strings.Contains(text, "AGENTCHUTE_AGENT_ID") {
		t.Fatalf("setup did not refresh CODEX.md to v31 env identity guidance:\n%s", text)
	}
