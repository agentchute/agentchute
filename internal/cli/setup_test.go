...
func TestSetupRefreshesExistingEnrollmentBlocks(t *testing.T) {
	...
	if !strings.Contains(text, "agentchute-enrollment v29 begin") || !strings.Contains(text, "AGENTCHUTE_AGENT_ID") {
		t.Fatalf("setup did not refresh CODEX.md to v29 env identity guidance:\n%s", text)
	}
