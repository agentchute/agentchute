...
func TestInitFreshEmpty(t *testing.T) {
	...
	expectAction(t, plan, "CLAUDE.md", "create v32")
	expectAction(t, plan, "CODEX.md", "create v32")
	expectAction(t, plan, "GEMINI.md", "create v32")
	expectAction(t, plan, "GROK.md", "create v32")
	expectAction(t, plan, "AGENTS.md", "create v32")
...
func TestInitPrependsBlockWhenNoMarker(t *testing.T) {
	...
	expectAction(t, plan, "CLAUDE.md", "prepend v32")
	applyAll(t, plan)
	...
	if !strings.Contains(string(got), "agentchute-enrollment v32 begin") {
...
func TestInitReplacesDriftedV1Content(t *testing.T) {
	...
	expectAction(t, plan, "CLAUDE.md", "replace v1→v32")
	applyAll(t, plan)
...
func TestInitUpgradesV11EnrollmentBlockToV13(t *testing.T) {
	...
	expectAction(t, plan, "CODEX.md", "replace v11→v32")
	applyAll(t, plan)
...
func TestInitLeavesNewerVersionAlone(t *testing.T) {
	root := t.TempDir()
	future := "<!-- agentchute-enrollment v33 begin -->\nfuture\n<!-- agentchute-enrollment v33 end -->\n"
...
// TestInitUpgradesV31EnrollmentToV32 is the enrollment-bump lock (introduced
...
// v31→v32"), a distinct action string from planEnrollmentFile's same-version
// "replace vN drift" branch, so the two never get confused in plan output.
// TestInitLeavesNewerVersionAlone (this file, now pinned to a v33 fixture)
...
// rewriting — the same generic branch a literal v31 binary against a v32 file
...
func TestInitUpgradesV31EnrollmentToV32(t *testing.T) {
	root := t.TempDir()
	old := "<!-- agentchute-enrollment v31 begin -->\nstale v31 content\n<!-- agentchute-enrollment v31 end -->\n\nMy notes.\n"
	...
	for _, a := range plan.Actions {
		...
		if a.Action != "replace v31→v32" {
			t.Errorf("action = %q, want %q", a.Action, "replace v31→v32")
		}
	...
	if !strings.Contains(string(got), "agentchute-enrollment v32 begin") {
		t.Errorf("CLAUDE.md was not upgraded to v32:\n%s", got)
	}
