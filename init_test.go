...
func TestInitFreshEmpty(t *testing.T) {
	...
	expectAction(t, plan, "CLAUDE.md", "create v7")
	expectAction(t, plan, "CODEX.md", "create v7")
	expectAction(t, plan, "GEMINI.md", "create v7")
	expectAction(t, plan, "AGENTS.md", "create v7")
...
func TestInitPrependsBlockWhenNoMarker(t *testing.T) {
	...
	expectAction(t, plan, "CLAUDE.md", "prepend v7")
	applyAll(t, plan)
	...
	if !strings.Contains(string(got), "agentchute-enrollment v7 begin") {
...
func TestInitReplacesDriftedV1Content(t *testing.T) {
	...
	expectAction(t, plan, "CLAUDE.md", "replace v1→v7")
	applyAll(t, plan)
...
func TestInitLeavesNewerVersionAlone(t *testing.T) {
	root := t.TempDir()
	future := "<!-- agentchute-enrollment v8 begin -->\nfuture\n<!-- agentchute-enrollment v8 end -->\n"
