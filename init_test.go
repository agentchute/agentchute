...
func TestInitFreshEmpty(t *testing.T) {
	...
	expectAction(t, plan, "CLAUDE.md", "create v17")
	expectAction(t, plan, "CODEX.md", "create v17")
	expectAction(t, plan, "GEMINI.md", "create v17")
	expectAction(t, plan, "GROK.md", "create v17")
	expectAction(t, plan, "AGENTS.md", "create v17")
...
func TestInitPrependsBlockWhenNoMarker(t *testing.T) {
	...
	expectAction(t, plan, "CLAUDE.md", "prepend v17")
	applyAll(t, plan)
	...
	if !strings.Contains(string(got), "agentchute-enrollment v17 begin") {
...
func TestInitReplacesDriftedV1Content(t *testing.T) {
	...
	expectAction(t, plan, "CLAUDE.md", "replace v1→v17")
	applyAll(t, plan)
...
func TestInitUpgradesV11EnrollmentBlockToV13(t *testing.T) {
	...
	expectAction(t, plan, "CODEX.md", "replace v11→v17")
	applyAll(t, plan)
...
func TestInitLeavesNewerVersionAlone(t *testing.T) {
	root := t.TempDir()
	future := "<!-- agentchute-enrollment v18 begin -->\nfuture\n<!-- agentchute-enrollment v18 end -->\n"
